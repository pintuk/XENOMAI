...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--enable-smp'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 6.3.0 20170516 (Raspbian 6.3.0-18+rpi1+deb9u1) "
...
/* config */
#define CONFIG_XENO_REVISION_LEVEL 7
...
/* config */
#define CONFIG_XENO_VERSION_NAME "Lingering Dawn"

/* config */
#define CONFIG_XENO_VERSION_STRING "3.0.7"
...
#define PACKAGE_STRING "Xenomai 3.0.7"
